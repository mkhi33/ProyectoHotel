 ...
 * @author aarve
 */
public class GuiCajaReservas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtEfectivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 340, 40, 10));
        ...
        jPanel1.add(lblCambio, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 390, -1, 10));
        ...
        jPanel1.add(cbxEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 90, 160, -1));

        lbl.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl.setForeground(new java.awt.Color(255, 255, 255));
        lbl.setText("Forma de pago");
        jPanel1.add(lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 110, -1));
        ...
        jPanel1.add(rbtnEfectivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 270, -1, -1));
        ...
        jPanel1.add(rbtnTarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, 80, -1));
        ...
        jPanel1.add(txtTarjetatxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, 220, 30));

        lbl1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl1.setForeground(new java.awt.Color(255, 255, 255));
        lbl1.setText("Cajero");
        jPanel1.add(lbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 60, -1));

        lblEfectivo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ID.png"))); // NOI18N
        jPanel1.add(lblEfectivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 330, 60, 30));

        lblTarjeta.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/caja de texto.png"))); // NOI18N
        jPanel1.add(lblTarjeta, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 320, 260, 50));

        lblCambiio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/ID.png"))); // NOI18N
        jPanel1.add(lblCambiio, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 60, 30));

        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("Confirmar pago");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 500, 110, -1));
        ...
        jPanel1.add(btnGuardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 460, 60, 40));
        ...
        jPanel1.add(btnReportes, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 460, 60, 40));

        jLabel12.setForeground(new java.awt.Color(0, 0, 0));
        jLabel12.setText("Generar reporte");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 500, 90, -1));
        ...
        jPanel1.add(btnCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 460, 60, 40));

        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("Cancelar");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 500, 50, -1));

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/Barra botones.png"))); // NOI18N
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 450, 450, -1));

        cbxReserva.setBackground(new java.awt.Color(204, 204, 204));
        cbxReserva.setForeground(new java.awt.Color(0, 0, 0));
        cbxReserva.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                cbxReservaMousePressed(evt);
            }
        });
        ...
        jPanel1.add(cbxReserva, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 90, 160, -1));

        lbl4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        lbl4.setForeground(new java.awt.Color(255, 255, 255));
        lbl4.setText("Reserva");
        jPanel1.add(lbl4, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 50, 70, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        try {
            ...
            int indexReserva = this.cbxReserva.getSelectedIndex();
          
            
            objEmpleado = PantallaPrincipal.gEmpleado.getObjetoEmpleado(indexEmpleado);
            objReserva = PantallaPrincipal.gRsv.getObjetoReserva(indexReserva);
              totalPago = (float) objReserva.getPrecioEstadia();
            if (this.efectivo) {
                formaPago = "Efectivo";
                ...
                if (montoEfectivo < totalPago) {
                    ...
                    if (JOptionPane.showConfirmDialog(this, "Confirmar pago", "Confirmar pago realizado", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                        ...
                        this.lblCostoTotal.setText(Float.toString(totalPago));

                        this.actualizarElementosEnTabla();// Tabla de reservas
                    ...
                    if (JOptionPane.showConfirmDialog(this, "¿Desea imprimir factura?", "Imprimir factura", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                        ...
                        Caja objCajero;
                        Date fecha;
                        int posicion = PantallaPrincipal.gCaja.lstCaja.size();
                        objCajero = PantallaPrincipal.gCaja.getObjCaja(posicion-1);
                        ...
                        String nombreArchivo = "FactReservas-"+tamanioFacturas;
                        String contenido = PantallaPrincipal.gFact.generarFacturaReserva();
                        String ruta = "FacturaReservas\\" + nombreArchivo;
                ...
                if (JOptionPane.showConfirmDialog(this, "¿Desea imprimir factura?", "Imprimir factura", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                        ...
                        Caja objCajero;
                        Date fecha;
                        int posicion = PantallaPrincipal.gCaja.lstCaja.size()-1;
                        objCajero = PantallaPrincipal.gCaja.getObjCaja(posicion);
                        Hotel htl = PantallaPrincipal.gHtl.objHotel(0);
                        fecha = AdminFechas.getFechaActual();
                        Factura objFactura = new Factura();
                        objFactura.setCajero(objCajero);
    ...
    private void tblReservasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblReservasMousePressed
        ...
        float totalEstadia = (float) objReserva.getPrecioEstadia();
        this.lblCostoTotal.setText(Float.toString(totalEstadia));
        cbxReserva.setSelectedIndex(posicionElemento);
    ...
    private void cbxReservaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cbxReservaMousePressed
        // TODO add your handling code here:

        
    }//GEN-LAST:event_cbxReservaMousePressed
